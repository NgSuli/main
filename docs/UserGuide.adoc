...
*Unrestricted search
Finds persons whose names, addresses, phones, emails, tags, major, remark or facebook id contain any of the given keywords or find favorite / unfavorite contacts. +
Format: `find KEYWORD [MORE_KEYWORDS]`

****
* The search is case insensitive. e.g `hans` will match `Hans`
* The order of the keywords does not matter. e.g. `Hans Bo` will match `Bo Hans`
* Any words containing the searched substring will be matched as weell e.g. `Han` will match `Hans`
...
with highest priority in the order: name > phone > address > email > tag > remark > major >
facebook id.
****
...
* person of specified index *within* the group is removed, so use `viewGroup` command to see the person in the group first
****

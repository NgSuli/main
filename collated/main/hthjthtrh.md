...
```
###### \java\seedu\address\commons\events\ui\RefreshGroupPanelSelectionEvent.java
``` java
package seedu.address.commons.events.ui;
...
``` fxml
    <SplitPane id="splitPane" fx:id="splitPane" dividerPositions="0.5, 0.5" VBox.vgrow="ALWAYS">
      <SplitPane dividerPositions="0.5" maxWidth="320.0" minWidth="200.0" orientation="VERTICAL" prefHeight="200.0" prefWidth="200.0">
         <items>
